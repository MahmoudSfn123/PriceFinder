            ...
            <div class="container">
                <div class="page-header">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-current">>Update User</span>
                    </div>
                </div>
                ...
                <div class="add-form-card">
                    <div class="card-header">
                        ...
                        <p class="card-description">Update the user details below</p>
                    </div>

                    <form class="product-form" method="POST" action="{{ route('admin.users.update', $user->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <select id="role" name="role" required>
                                    ...
                                    <option value="1" {{ old('role', $user->is_admin) == 1 ? 'selected' : '' }}>
                                        Admin</option>
                                    <option value="0" {{ old('role', $user->is_admin) == 0 ? 'selected' : '' }}>
                                        User</option>
                                </select>
