            ...
            <div class="container">
                ...
                <div class="add-form-card">
                    <div class="card-header">
                        ...
                        <p class="card-description">Create a new product with pricing information.</p>
                    </div>
                    ...
                    <form class="product-form" method="POST" action="{{ route('admin.products.store') }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <select id="productName" name="productName" @error('productName') is-invalid @enderror
                                    required>
                                    <option value="" disabled selected>Select a product</option>
                                    @foreach ($products as $item)
                                        <option value="{{ $item->name }}"
                                            {{ old('productName') == $item->name ? 'selected' : '' }}>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" id="purchaseDate" name="purchase_date" placeholder="mm/dd/yyyy"
                                    required>
                                @error('purchase_date')
                                    <div class="error">
                                        <div class="error__icon">
                        ...
                        <div class="image-section">
                            <div>
                                ...
                                <div class="image-upload">
                                    <div class="upload-area" id="upload-area-admin-image">
                                        <input type="file" id="adminImageUpload" name="image_path" accept="image/*"
                                            hidden>
                            ...
                            <div>
                                ...
                                <div class="invoice-upload">
                                    <div class="upload-area" id="upload-area-admin-invoice">
                                        <input type="file" id="adminInvoiceUpload" name="invoice" accept="image/*"
                                            hidden>
                                    ...
                                    <div class="preview-area" id="preview-area-admin-invoice" style="display: none;">
                                        <img id="previewInvoiceAdmin" src="" alt="Invoice preview">
